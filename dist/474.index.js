...
// EXTERNAL MODULE: ./vendor/json-with-bigint/json-with-bigint.js
var json_with_bigint = __webpack_require__(1965);
...
async function fetchWrapper(requestOptions) {
  ...
  const body = dist_bundle_isPlainObject(requestOptions.body) || Array.isArray(requestOptions.body) ? (0,json_with_bigint/* JSONStringify */.i)(requestOptions.body) : requestOptions.body;
...
async function getResponseData(response) {
  ...
  if (isJSONResponse(mimetype)) {
    ...
    try {
      ...
      return (0,json_with_bigint/* JSONParse */.Q)(text);
    } catch (err) {
      return text;
    }
